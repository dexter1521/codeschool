      ...
      if($this->input->get('opt') == 'addst') {
        ...
        <form action="<?php echo base_url('student/create') ?>" method="post" id="createStudentForm" enctype="multipart/form-data">  
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="nempelado" name="nempelado" placeholder="Numero de empleado" autocomplete="off" >
            </div>
        ...
        <!--    <div class="form-group">
           ...
           -->
            <div class="form-group">
              <label for="contact">Numero de telefono</label>
                <input type="text" class="form-control" id="contact" name="contact" placeholder="Numero de telefono" autocomplete="off">
            </div>
            <div class="form-group">
          ...
          <div class="col-md-12">
            ...
            <!--   <button type="button" class="btn btn-default">Reiniciar</button>   -->   
            </center>       
          </div>
