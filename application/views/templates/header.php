    ...
    <nav class="navbar navbar-inverse navbar-static-top">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">TSJMOR</a>
          </div>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown" id="topStudentMainNav">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> 
                    <i class="glyphicon glyphicon-list-alt"></i> Estudiantes <span class="caret"></span></a>
              ...
              <li class="dropdown" id="topAttendanceMainNav">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="glyphicon glyphicon-time">
                    </i> Asistencia <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li id="takeAttendNav"><a href="<?php echo base_url('attendance?atd=add') ?>">Asistencia</a></li>
                  <li id="attenReport"><a href="<?php echo base_url('attendance?atd=report') ?>">Reporte de Asistencia</a></li>
                  <li id=""><a href="<?php echo base_url('Asistencia') ?>">Checador</a></li>
                </ul>
              </li>
...
<!-- 
             <li class="dropdown" id="topMarksheetMainNav">
                ...
                <ul class="dropdown-menu">
                  <li id="manageMarksheet"><a href="<?php echo base_url('marksheet?opt=mngms') ?>">Administrar Calificaciones</a></li>
                  <li id="manageMarks"><a href="<?php echo base_url('marksheet?opt=mgmk') ?>">Administrar Marcas</a></li>
                </ul>
              </li>
 -->
 <!--
